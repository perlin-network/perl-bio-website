...
function Splash() {
    return (        
            ...
            > 
                <div className='splash-background' style={{backgroundImage: `url(${Background})`, backgroundSize:'fit', backgroundRepeat:'no-repeat', backgroundPosition:'center center', padding:'2% 0%'}}>
                        <Grid container justify='space-between' style={{maxWidth:'100%', margin:'0% 5%'}}>
                ...
                <div className='partner-container' style={{marginTop:'75px', maxWidth:'100%'}}>
                    <p style={{...contentTextStyle, color:"#A5AFA8", margin:'0% 5%'}}>Partners</p>
                    <Grid container direction='column'>
