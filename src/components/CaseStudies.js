    ...
    let gridItems=[
        {
            ...
            content:`
            The Gorilla Project is the first voluntary REDD+ project in the Republic of Congo (RoC) that will reduce GHG emissions by avoiding deforestation and degradation under the VCS Standard. The NPR+ Project began as an idea in 2010, and formally began its crediting period in 2012; it is the initial REDD+ Pilot project of the Republic of Congo. The Project protects 92,530 hectares of pristine unlogged rainforest. 
...
The NPR+ project area contains a total of 22 protected species considered by the IUCN & CITES. Such as the Lowland Gorilla (Gorilla gorilla gorilla), African Forest Elephant (Loxodonta cyclotis), Hippopotamus (Hippopotamus amphibius) & Leopard (Panthera pardus)
        ...
        },
        {
            ...
            title:`Tiger Project`,
            content:`
            The Tiger Project seeks to protect and restore 130,090 ha of peatland ecosystem located in the Republic of Indonesia while at the same time preserving biodiversity and enhancing local livelihoods. The Project will avoid 78,425 ha of forest clearing and conversion to an industrial forestry plantation. The Project is on the island of Sumatra and in the Province of Riau. Specifically, it is located on the Kampar Peninsula, which is a rain-fed peatland forest made up of four former logging concessions. 
